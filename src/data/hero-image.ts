...
export const HERO_COVER_IMAGE = 'https://storage.yandexcloud.net/vfd74ru/Main_page/left_bento/urban_main_cover.webp'
...
export const HERO_COVER_IMAGE_MOBILE = '/renders/hero/urban-main-cover-mobile.webp'
