    ...
    <div class="container">
      ...
      >
        <!-- Фото — без текстового оверлея, суть продукта в том, что дверь
             ...
             lg:max-h-125 (при items-stretch контейнер растягивался под высоту
             текстовой колонки — object-cover кадрировал под непредсказуемое
             соотношение сторон, а не под реальные пропорции фото 1672:941) —
             теперь на lg тот же честный видео-аспект, что и до него, высота
             не зависит от соседней колонки. -->
